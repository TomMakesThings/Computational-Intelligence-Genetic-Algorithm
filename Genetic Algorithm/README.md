...
<img width=100 src="https://render.githubusercontent.com/render/math?math=min\{f_{1}, f_{2}\}">
...
For <img width=180 src="https://render.githubusercontent.com/render/math?math=-4.0 \le x_{1}, x_{2}, x_{3} \le 4.0">
...
| Individual | $x_{1}$    | $x_{1}$    | $x_{1}$    | $f_{1}$  | $f_{2}$  |
| ---------- | ---------- | ---------- | ---------- | -------- | -------- |
...
Uniform crossover is applied to parent pairs at a chance of 0.9. If no crossover occurs, parents’ genes are directly transferred to resulting offspring. Mutation is applied to the created offspring at a chance inversely proportionate to the chromosome size.
